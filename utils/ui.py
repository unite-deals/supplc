...
def introduction():
    st.title('AI & Machine Learning Analysis & Product Segmentation -Supply chain analytics 🛍️')
   
       # User Guide/Source Guide
    col1, col2 = st.sidebar.beta_columns(2)
    with col1:
        st.sidebar.markdown('''📖 [Contact Us ](https://www.technoglobalgroupllc.com/contacts)''')
    with col2:
...
def upload_ui():
    ...
    # Let's connect
    st.sidebar.markdown('''😀 [LET'S CONNECT! : virtual3v@gmail.com]''')
